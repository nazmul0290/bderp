...
const Button = ({ type = "submit", className, secondary, ...props }) => (
  <button
    ...
    } inline-flex items-center justify-center px-4 py-2  border border-transparent rounded-md font-semibold text-xs h-10  uppercase tracking-widest  focus:outline-none  focus:ring  disabled:opacity-25 transition ease-in-out duration-150`}
    {...props}
  />
);
